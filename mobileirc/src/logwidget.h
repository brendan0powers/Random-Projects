...
class LogWidget : public QWidget, private Ui::LogUi, public ChannelBase
{
	Q_OBJECT

public:
	LogWidget(QxtIrcConnection *c, QWidget* parent = 0, Qt::WFlags fl = 0);
	~LogWidget();
...
public slots:
	...
	virtual void clear();
	virtual void send();
	virtual MainWindow::Scope type() {return MainWindow::Server;}
        virtual void focus();
        void activate();
