...
namespace OgreOde_Prefab 
{
	...
	public:
		...
		bool pickTrimesh(OgreOde::RayGeometry *ray, OgreOde::Body* &body, Ogre::Vector3 &position, OgreOde::World *world, OgreOde::Space* space);
		bool pickRagdoll(OgreOde::RayGeometry *ray, OgreOde::Body* &body, Ogre::Vector3 &position);
	...
	protected:
		...
		void setRecursiveManuallyControlled(Ogre::Bone* bone, const bool val);
